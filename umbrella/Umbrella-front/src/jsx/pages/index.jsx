                    ...
                    <div className="row justify-content-between align-items-center">
                        <div className="col-xl-6 col-lg-6 col-12">
                            <div className="intro-content">
                                <h1>{t("Trade with ")}
                                    <strong className="text-primary">Umbrella Exchange</strong>.
                                    <br/>
                                    {t("Buys and sell criptocurrencies")}
                                </h1>
                                <p>{t("Fast and safe")}</p>
                            </div>
                            ...
                            <div className="intro-btn">
                                <Link to={'./signin'}
                                    className="btn btn-primary mb-2">Login</Link>
                                <Link to={'/signup/createUser'}
                                    className="btn btn-outline-primary">{t("Be part of the revolution")}</Link>
                            </div>
                        </div>
                            ...
                            <div className="intro-form-exchange">
                                <form method="post" name="myform" className="currency_validate">
                                    <div className="form-group">
                                        <label className="mr-sm-2">Compre</label>
                                        <div className="input-group mb-3">
                                            <select name='currency' className="form-control">
                                                <option data-display="USD" value="USD">USD</option>
                                                <option value="BTC">BTC</option>
                                                <option value="IDSUEX">IDSUEX</option>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-6">
                                        <div className="media">
                                            ...
                                            <div className="media-body">
                                                <h4>Mobile apps</h4>
                                                <p>Stay on top of the markets with the Tradio app for
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-6">
                            <div className="section-title text-center">
                                ...
                                <p>
                                    All of our products are ready to go, easy to use and offer great value to any kind of
                                                                                                                                            business
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-auto">
                                    <div className="trusted-logo">
                                        <Link to={'#'}><img className="img-fluid"
                                                src={
                                                    require('./../../images/brand/1.webp')
                                                }
                                                alt=""/></Link>
                                    </div>
                                </div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-8">
                            <div className="section-title text-center">
                                ...
                                <p>
                                    Here are a few reasons why you should choose Tradio
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="promo-content">
                                <div className="promo-content-img">
                                    <img className="img-fluid"
                                        src={
                                            require('./../../images/svg/protect.svg')
                                        }
                                        alt=""/>
                                </div>
                                <h3>Secure storage
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-4">
                            <div className="promo-content">
                                <div className="promo-content-img">
                                    <img className="img-fluid"
                                        src={
                                            require('./../../images/svg/finance.svg')
                                        }
                                        alt=""/>
                                </div>
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-footer">
                                        <div className="meta-info">
                                            <Link to={'#'}
                                                className="author"><img src={
                                                        require('./../../images/avatar/5.jpg')
                                                    }
                                                    alt=""/>
                                                Admin</Link>
                                            <Link to={'#'}
